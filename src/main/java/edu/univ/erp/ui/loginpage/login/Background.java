...
public class Background extends JComponent {
    ...
    private login.CrossButton closeButton;
    private login.LogoComponent iiitdLogo;
...
//            int randomNumber = 2;
            String fileName = "iiitd_background.jpeg";
            // This looks for the image inside the resources folder
            image = new ImageIcon(ImageIO.read(getClass().getResource("/resources/" + fileName)));
        } catch (Exception e) {
            e.printStackTrace();
        }
