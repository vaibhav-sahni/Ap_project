package edu.univ.erp.ui.instructordashboard.components;
...
import edu.univ.erp.ui.instructordashboard.swing.slider.SliderTransition;
...
public class MainForm extends JPanel {
    ...
    private JButton createButton(Icon icon) {
        ...
        button.putClientProperty(FlatClientProperties.STYLE, "" + "background:$Button.toolbar.background;" + "arc:10;" + "margin:3,3,3,3;"
