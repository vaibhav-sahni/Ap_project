package edu.univ.erp.ui.admindashboard.menu;
...
import edu.univ.erp.ui.admindashboard.components.MainForm;
...
public class FormManager {
    ...
    public static void refreshStudentViews() {
        for (SimpleForm f : instance.forms) {
            ...
            if (cname.equals("edu.univ.erp.ui.admindashboard.forms.DashboardForm") || cname.equals("edu.univ.erp.ui.admindashboard.forms.MyCoursesForm")) {
                try {
