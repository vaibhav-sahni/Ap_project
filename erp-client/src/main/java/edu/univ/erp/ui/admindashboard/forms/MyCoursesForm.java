 ...
 * currently registered for. This form merges three data sources: - timetable
 * (registered/currently enrolled sections), - course catalog (metadata like
 * credits, section, instructor), and - grades/transcript (to mark completed
 * courses).
 *
 * The UI displays a searchable, filterable table with columns for code, title,
 * credits, section, schedule, room, instructor, status and actions.
 */
public class MyCoursesForm extends SimpleForm {
                ...
                try {
                    ...
                    if (cu != null) {
                        ...
                        edu.univ.erp.ui.utils.UIHelper.runAsync(() -> {
                            ...
                            java.util.List<edu.univ.erp.domain.CourseCatalog> timetable = (java.util.List<edu.univ.erp.domain.CourseCatalog>) results.get("timetable");
                            @SuppressWarnings("unchecked")
                            java.util.List<edu.univ.erp.domain.CourseCatalog> catalog = (java.util.List<edu.univ.erp.domain.CourseCatalog>) results.get("catalog");
                            @SuppressWarnings("unchecked")
                            java.util.List<edu.univ.erp.domain.Grade> grades = (java.util.List<edu.univ.erp.domain.Grade>) results.get("grades");
    ...
    /**
     * Renderer + Editor for the Actions column. Displays a contextual button
     * (e.g., Drop) when applicable. This class implements both the
            ...
            actionButton.addActionListener(e -> {
                ...
                if (cs.isRegistered && cs.dropAllowed) {
                    ...
                    edu.univ.erp.ui.utils.UIHelper.runAsync(() -> studentAPI.dropCourse(uid, sectionId), (String msg) -> {
                        ...
                        try {
                            javax.swing.SwingUtilities.invokeLater(() -> edu.univ.erp.ui.admindashboard.menu.FormManager.refreshStudentViews());
                        } catch (Throwable ignore) {
                        }
                    }, (Exception ex) -> {
